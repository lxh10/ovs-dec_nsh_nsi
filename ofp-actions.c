...
static enum ofperr
decode_NXAST_RAW_DEC_NSH_NSI(struct ofpbuf * out)
{
    ofpact_put_DEC_NSH_NSI(out)->ofpact.raw = NXAST_RAW_DEC_NSH_NSI;
...
static void
encode_DEC_NSH_NSI(const struct ofpact_null *null OVS_UNUSED,
                  enum ofp_version ofp_version OVS_UNUSED, struct ofpbuf *out)
{
    put_NXAST_DEC_NSH_NSI(out);
}
...
static char * OVS_WARN_UNUSED_RESULT
parse_DEC_NSH_NSI(char *arg OVS_UNUSED, struct ofpbuf *ofpacts,
                 enum ofputil_protocol *usable_protocols OVS_UNUSED)
{
    ofpact_put_DEC_NSH_NSI(ofpacts)->ofpact.raw = NXAST_RAW_DEC_NSH_NSI;;
    return NULL;
}
...
static void
format_DEC_NSH_NSI(const struct ofpact_null *a OVS_UNUSED, struct ds *s)
{
    ds_put_format(s, "dec_nsh_nsi");
}
